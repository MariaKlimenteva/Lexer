...
/**
 ** \file /home/masha/code_projects/MIPT_Ilab/ParaCL/build/ParaCL.tab.hh
...
#ifndef YY_YY_HOME_MASHA_CODE_PROJECTS_MIPT_ILAB_PARACL_BUILD_PARACL_TAB_HH_INCLUDED
# define YY_YY_HOME_MASHA_CODE_PROJECTS_MIPT_ILAB_PARACL_BUILD_PARACL_TAB_HH_INCLUDED
...
#line 55 "/home/masha/code_projects/MIPT_Ilab/ParaCL/build/ParaCL.tab.hh"
...
namespace yy {
#line 189 "/home/masha/code_projects/MIPT_Ilab/ParaCL/build/ParaCL.tab.hh"
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == 0 || tok == token::OR || tok == token::AND || tok == token::GREATER || tok == token::GREATEREQ || tok == token::LESS || tok == token::LESSEQ || tok == token::MINUS || tok == token::ASSIGN || tok == token::PLUS || tok == token::SCOLON || tok == token::MULTIPLY || tok == token::DIVIDE || tok == token::LPAREN || tok == token::RPAREN || tok == token::LBRACE || tok == token::RBRACE || tok == token::NOTEQUAL || tok == token::EQUAL || tok == token::INPUT || tok == token::IF || tok == token::WHILE || tok == token::ELSE || tok == token::ERR);
      }
#else
      symbol_type (int tok)
        : super_type(token_type (tok))
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      make_GREATEREQ ()
      {
        return symbol_type (token::GREATEREQ);
      }
#else
      static
      symbol_type
...
#line 1370 "/home/masha/code_projects/MIPT_Ilab/ParaCL/build/ParaCL.tab.hh"





#endif // !YY_YY_HOME_MASHA_CODE_PROJECTS_MIPT_ILAB_PARACL_BUILD_PARACL_TAB_HH_INCLUDED
